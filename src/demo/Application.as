...
public class Application extends Sprite3D implements IStartable {
...
//        var perspectiveView: PerspectiveView = new PerspectiveView(_assets.getTexture("floor"));
//        var perspectiveView: PerspectiveView = new PerspectiveView(_assets.getTexture("metal_floor"));
        var perspectiveView: PerspectiveView = new PerspectiveView(_assets.getTexture("test_floor"));
